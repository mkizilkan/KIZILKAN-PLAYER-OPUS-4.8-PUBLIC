...
export default function PlaylistSelect() {
  ...
  // GPT ELITE v12.0.0: yalnız aktif profilin playlist metadata'sı kesin olarak
  // yüklendikten sonra ve TEK kez yönlendir.
  useEffect(() => {
    if (isLoading) return;
  ...
  }, [isLoading, loadedProfileId, activeProfile.id, sorted, activePlaylist?.id, router, setActivePlaylist, homeRoute]);
