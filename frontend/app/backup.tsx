...
export default function BackupScreen() {
  ...
  const doImport = async () => {
    ...
    try {
      ...
      setMsg({ type: "ok", text: `Yedek geri yüklendi (${result.restored} kayıt). Uygulamayı yeniden başlatın — liste içerikleri (kanal/film/dizi) ilk açılışta kaynağından otomatik indirilecek.` });
    } catch (e: any) {
