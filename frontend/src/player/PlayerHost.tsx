...
export default function PlayerHost() {
  ...
  useEffect(() => {
    ...
    setSheet(null);
    // v10.4.0: bekleyen pause-yedeği zamanlayıcısı YENİ kanalı durdurmasın.
    ...
    if (useVLC) {
      ...
      if (isPlaying) {
        ...
        pauseFallback.current = setTimeout(() => {
          // Hâlâ oynuyorsa (canlı yayında pause yok sayıldı) akışı durdur.
