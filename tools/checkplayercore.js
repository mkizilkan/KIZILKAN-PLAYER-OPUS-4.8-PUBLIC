#!/usr/bin/env node
/**
 * GPT KIZILKAN PLAYER ELITE — PLAYER CORE HARD GATE (v15.0.0)
 *
...
if (app?.expo?.version !== '15.0.0') problem(`app version ${app?.expo?.version} (15.0.0 bekleniyor)`);
if (app?.expo?.android?.versionCode !== 150000) problem(`versionCode ${app?.expo?.android?.versionCode} (150000 bekleniyor)`);
